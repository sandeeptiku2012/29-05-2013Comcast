...
public class DataServiceProperties {
	...
	static 
	{
		...
		_INVALID_PASSWORD_LENGTH=rsbundle.getString("INVALID_PASSWORD_LENGTH");
		...
		_INVALID_CC_PIN_CODE_LENGTH=rsbundle.getString("INVALID_CC_PIN_CODE_LENGTH");
		_INVALID_CC_NUMBER=rsbundle.getString("INVALID_CC_NUMBER");
		_INVALID_CC_SECURITY_CODE_CHAR=rsbundle.getString("INVALID_CC_SECURITY_CODE_CHAR");
		_INVALID_CC_SECURITY_CODE=rsbundle.getString("INVALID_CC_SECURITY_CODE");
		_INVALID_CC_SECURITY_CODE_LENGTH=rsbundle.getString("INVALID_CC_SECURITY_CODE_LENGTH");
		_INVALID_CC_EXPIRY_MONTH=rsbundle.getString("INVALID_CC_EXPIRY_MONTH");
